...
* Create groups of media (Movies, TV Shows, Animes, Games, Books, etc)
* Add media to each group (Name, genre, episodes, etc)
* Have an easy way to move items from "Backlog" to "In progress"
* Have an easy way to increase the number of episodes, chapters, etc.
* Have a rating system
* Have a logging system (Calendar of start/end)
* Have a way to "edit" metadata of the items
* Have a way to "edit" start or finish dates
